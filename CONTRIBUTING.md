...
| DATABASE_TLS                       | Database connection over TLS (when DATABASE_TYPE is postgres)                                                                                                                                                                                                                       | Boolean                                          | false                               |
| DATABASE_CERT                      | Database client certificate in base64-encoded PEM                                                                                                                                                                                                                                   | String                                           |                                     |
| DATABASE_KEY                       | Database client certificate key in base64-encoded PEM                                                                                                                                                                                                                               | String                                           |                                     |
| DATABASE_CA                        | Database server CA certificate in base64-encoded PEM                                                                                                                                                                                                                                | String                                           |                                     |
| REDIS_TLS                          | Redis connection over TLS (when app is in QUEUE mode)                                                                                                                                                                                                                               | Boolean                                          | false                               |
| REDIS_CERT                         | Redis client certificate in base64-encoded PEM                                                                                                                                                                                                                                      | String                                           |                                     |
| REDIS_KEY                          | Redis client certificate key in base64-encoded PEM                                                                                                                                                                                                                                  | String                                           |                                     |
| REDIS_CA                           | Redis server CA certificate in base64-encoded PEM                                                                                                                                                                                                                                   | String                                           |                                     |
